script FileTagReader
  ...
  on decodeUnicode(input)
    return do shell script "python3 /Users/dmitryvasilkov/IdeaProjects/Mac-automation-scripts/File-relatedScripts/DeletingAllScreenshotsAndRedFlagFilesFinalVersion/decoding.py " & quoted form of input
  end decodeUnicode
